...
<body>
    ...
    <script>
        function validateForm() {
            ...
            if (firstName === "") {
                document.getElementById("firstNameError").innerHTML = "Harap isi kolom ini.";
                valid = false;
            } else {
            ...
            if (lastName === "") {
                document.getElementById("lastNameError").innerHTML = "Harap isi kolom ini.";
                valid = false;
            } else {
            ...
            if (email === "") {
                document.getElementById("emailError").innerHTML = "Harap isi kolom ini.";
                valid = false;
            } else {
            ...
            if (phone === "") {
                document.getElementById("phoneError").innerHTML = "Harap isi kolom ini.";
                valid = false;
            } else {
